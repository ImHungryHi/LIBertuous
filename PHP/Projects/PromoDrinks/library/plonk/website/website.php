...
class PlonkWebsite
{
	...
	/**
	 * key in the $_POST array which holds the action to perform
	 * @var String
	 */
	static $actionKey;
	 ...
	 * @return void
	 */
	public function __construct($modules, $moduleKey = 'module', $viewKey = 'view', $actionKey = 'moduleAction')
	{
		// store variables
		$this->modules 		= (array) $modules;
		self::$moduleKey	= (string) $moduleKey;
		self::$viewKey		= (string) $viewKey;
		self::$actionKey	= (string) $actionKey;
	...
	private function performPrerequisites()
	{
		...
		// Start a session - deprecated, use OneArchySession instead
		//PlonkSession::start();
