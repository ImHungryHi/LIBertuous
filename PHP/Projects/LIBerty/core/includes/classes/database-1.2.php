 ...
 * @author		Chris De Smedt <chris.de.smedt.91@gmail.com>
 * @version		1.2 - Upgrade to mysqli code
 *				1.1 - IMPROVEMENT: Added backticks around fieldnames and tablenames, allowing one to use keywords as field/table-names (which you shouldn't, but hey)
 * 					  IMPROVEMENT: Code reformatted to resemble the ikdoeict coding guidelines
 * 					  BUGFIX: Now respects NULL and numeric values in insert() and update() functions by not adding quotes around them
